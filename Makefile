...
c8: raylib
ifneq (,$(c8_config))
	@echo "==== Building c8 ($(c8_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f c8.make config=$(c8_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f c8.make clean
