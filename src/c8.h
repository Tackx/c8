...
// Display
const unsigned int C8_HEIGHT_PIXELS = 32;
const unsigned int C8_WIDTH_PIXELS = 64;
const unsigned int C8_RESOLUTION_MULTIPLIER = 10;
const unsigned int C8_ACTUAL_WIDTH = C8_WIDTH_PIXELS * C8_RESOLUTION_MULTIPLIER;
const unsigned int C8_ACTUAL_HEIGHT = C8_HEIGHT_PIXELS * C8_RESOLUTION_MULTIPLIER;

// Memory
const unsigned int C8_RAM_SIZE = 4096;
const unsigned int C8_FONT_START_LOCATION = 0x050;
const unsigned int C8_PROGRAM_START_LOCATION = 0x200;
